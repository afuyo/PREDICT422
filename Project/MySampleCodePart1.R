...
inPath = file.path("C:","playground","Predict422","Project")
...
#contains both continuous and categorical so I'll exclude categorical
charity_sub<-c("DAMT","AGE","MEDAGE","MEDPPH","MEDHVAL","MEDINC","MEDEDUC","NUMPROM","NUMPRM12","RAMNTALL",
               "NGIFTALL","MAXRAMNT","LASTGIFT","TDON")
charity_cont<-charityData[charity_sub]
...
names(charityData)
#Lets examine the means of the variables. Some of them are logical and will return NA.
#at the moment I'll leave the categorical variables out. 
